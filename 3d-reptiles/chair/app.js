...
import {
  ...
  exposedMarks,
  shrinkOne
} from "./chair-gcts.js?v=20260923-centered-union";
...
import { makeReliefVisual } from './relief-visual.js?v=20260923-centered-union';
...
function showGrowthStep(direction) {
  ...
  if (!searchWorker) searchWorker = new Worker(new URL('./search-worker.js?v=20260923-centered-union', import.meta.url), {type:'module'});
