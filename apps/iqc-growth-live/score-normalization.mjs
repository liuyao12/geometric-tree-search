...
export const SCORE_NORMALIZATION_SPECS = Object.freeze({
  ...
  "ionic-pair": spec("incremental q_i q_j / r pair geometry or declared-medium finite Coulomb ΔU", "supplied charge² / Å or electronvolt", "d_nn and selected finite reach; optional declared ε_r and Kelvin T", "geometry mode normalizes r by d_nn; Coulomb mode evaluates ΔU and maps x=ΔU/(N_added k_B T) through -x/(1+|x|)", "bounded ionic-pair ordering coordinate"),
