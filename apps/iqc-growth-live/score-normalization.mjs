...
export const SCORE_NORMALIZATION_SPECS = Object.freeze({
  ...
  "ionic-pair": spec("incremental q_i q_j / r pair geometry or declared-medium finite Coulomb with optional generic Born–Mayer A exp(-r/rho) and exact emitted-site gradient", "supplied charge² / Å, electronvolt, or electronvolt/Å", "d_nn and selected finite reach; optional declared ε_r, A, rho, and Kelvin T", "geometry mode normalizes r by d_nn; finite pair energy maps x=ΔU/(N_added k_B T) through -x/(1+|x|), force cancellation maps y=F_rms d_nn/(k_B T) through (1-y)/(1+y), and combined takes their equal mean", "bounded ionic-pair energy-gradient ordering coordinate"),
