...
const RECURSIVE_BENCHMARKS = {
  iceIh: { hierarchy: [1, 9, 1], curve: [216], mark: "molecule + bridge + void atlas", action: "6 commuting cover waves", speed: "71 tree actions / 216 atoms", gate: "pass · generic known-window cover", status: "pass", note: "A generic covalent-component learner receives species and Cartesian positions; a periodic metric is optional. It receives no ice label, H₂O formula, coordination, or ring size. It discovers one H₂O isometry class, 9 decorated nearest-shell bridge classes, and one six-member void-boundary class; 144 connections grow all 216 atoms in six visible antichains with zero backtracking. The same finite point set also passes with the cell withheld. The gallery shows the smaller directional hydrogen-bond subset for legibility. Blind exterior ice growth remains open." },
  iceIc: { hierarchy: [1, 6, 1], curve: [192], mark: "molecule + bridge + void atlas", action: "6 commuting cover waves", speed: "63 tree actions / 192 atoms", gate: "pass · cross-polytype transfer", status: "pass", note: "The same learned H₂O and O₆ void signatures transfer unchanged to cubic ice. The generic learner finds 6 decorated bridge classes and 128 nearest-shell connections, then grows the complete 192-atom known window in six visible antichains with zero backtracking. This is exact re-covering, not a stationary or exponential ice claim." },
...
RECURSIVE_BENCHMARKS.iqc.connection.macro.selection = "depth-conditioned branch marking · top-one 81/85 supplied stages (95.3%) · recurrent-state beam retains 85/85 with budgets 4→4→8 · consumed closed loop still 0 exact terminals / selected 2 of 3 atoms · autonomous gate red";
