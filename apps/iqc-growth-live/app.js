...
const RECURSIVE_BENCHMARKS = {
  iceIh: { hierarchy: [1, 9, 1], curve: [216], mark: "molecule + bridge + void atlas", action: "6 commuting cover waves", speed: "71 tree actions / 216 atoms", gate: "pass · generic known-window cover", status: "pass", note: "A generic covalent-component learner receives species, Cartesian positions, and the periodic metric—no ice label, H₂O formula, coordination, or ring size. It discovers one H₂O isometry class, 9 decorated nearest-shell bridge classes, and one six-member void-boundary class; 144 connections grow all 216 atoms in six visible antichains with zero backtracking. The gallery shows the smaller directional hydrogen-bond subset for legibility. Blind exterior ice growth remains open." },
