...
export function buildFiniteTransitionNetwork(rawHistory) {
  ...
  const directedEdges = [...activeDirected.entries()].sort(([first], [second]) =>
    ...
    attemptFrequencyPerSecond: record.attemptFrequencyPerSecond,
    attemptFrequencyUncertaintyLog10: record.attemptFrequencyUncertaintyLog10,
    ...
    prefactorSettingsSha256: record.prefactorSettingsSha256,
    temperatureApplicability: record.temperatureApplicability,
