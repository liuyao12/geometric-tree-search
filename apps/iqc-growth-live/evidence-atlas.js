...
const CLAIMS = [
  ...
  ["open", "Finite message quotient", "Bounded message passing preserves graph topology but exact neighborhood hashes fragment into 80,323 / 161,768 node colors and remain 14 / 20. Learn the quotient on train folds only."],
