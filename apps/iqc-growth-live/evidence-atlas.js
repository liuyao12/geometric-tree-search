...
const CLAIMS = [
  ...
  ["progress", "Successor-state value", "Each shortlisted action is executed hypothetically and scored by the frozen port frontier it creates. This target-free one-step value improves the expanded IQC result from 30 / 36 to 31 / 36; five actions remain wrong, so confirmation stays sealed."],
