...
const TIMELINE = [
  ...
  ["10", "Open frontier", "Learn a transferable stationary quasicrystal production and execute it to the million-site benchmark without a family-specific backend.", "open"],
];
