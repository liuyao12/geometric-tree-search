...
const TIMELINE = [
  ...
  ["17x", "Conditional child value rejected", "Conditioned on those closure parents, a 3,994-candidate / 95-positive child marking supplies all 14 exact parent branches under four-nucleus holdout. On the fifth consumed geometry, however, the two exact continuations rank 132nd and 133rd. Six feature ablations remain outside top 16; even the four-score legacy section reaches only ranks 95 and 96. The missing signal is parent→child obligation change, not merely fewer bins.", "open"],
