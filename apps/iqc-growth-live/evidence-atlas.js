...
const PHYSICS_MAP = {
  ...
  kinetics: {
    ...
    boundary: "The portal predicts structurally admissible continuation, not a growth rate or thermodynamic phase diagram. Final, first, and pooled references are geometry-only sensitivity choices. The fixed ridge surrogate fits source labels; cross-archive use freezes it and requires the same reduced composition, periodicity, program/version, exact canonical normalized method record, units, target, and reference. Target labels score only after prediction. One compatible archive is still not broad validation, causality, a potential, a force field, kinetics, or time, and no fitted model enters growth.",
    systems: [
