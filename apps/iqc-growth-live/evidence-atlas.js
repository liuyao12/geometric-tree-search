...
const TIMELINE = [
  ...
  ["18", "Open frontier", "Learn a train-only adaptive or channel-diverse reach policy that exposes rank-12 continuations without exploding the roughly 900-pose frontier, then select and promote the resulting antichain into a recurring oriented production.", "open"],
];
