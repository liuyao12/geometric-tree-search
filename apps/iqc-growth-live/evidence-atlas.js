...
const PHYSICS_MAP = {
  ...
  kinetics: {
    ...
    boundary: "The portal predicts structurally admissible continuation, not a growth rate or thermodynamic phase diagram. Final, first, and pooled references are geometry-only sensitivity choices rather than label-selected models. The fixed ridge surrogate explicitly fits archived labels, but its leave-one-frame-out folds remain correlated and it never enters growth. Neither scatter nor surrogate establishes independent validation, transferable prediction, causality, a potential, a force field, kinetics, or time. MD/DFT or experimental labels must calibrate kinetic claims separately.",
    systems: [
