...
const CLAIMS = [
  ...
  ["progress", "Directed obligation value", "Keeping each root→child port obligation separate raises expanded IQC selection to 33 / 36 and 16 / 18 exact nuclei. A four-branch path tree beats both static and pooled-successor models; confirmation remains sealed."],
