...
const TIMELINE = [
  ...
  ["17r", "Executable third-block split", "Forty retained parents generate 5,091 target-free terminals at the expanded radius before one consumed target open. Exact parents survive in eight nuclei; the complete tree has 90 exact paths across six, but the four-channel portfolio keeps only six paths across three. Two failures are candidate-supply failures and three are marking-pruning failures, now cleanly separated.", "open"],
