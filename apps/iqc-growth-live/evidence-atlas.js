import { executeIceMolecularAnchorGrowth } from "./ice-molecular-anchor-growth.js?v=20260901-414";
import { buildPeriodicIceIhBoundarySeries } from "./ice-periodic-boundary-audit.mjs?v=20260901-414";
...
import { buildHierarchyPhysicsTransport, HIERARCHY_TRANSPORT_STAGES }
  from "./hierarchy-physics-transport.mjs?v=20260901-414";
import { buildHierarchyPhysicsInvestigation }
  from "./hierarchy-physics-investigation.mjs?v=20260901-414";
import { buildHierarchyPhysicsProtocolPacket, hierarchyPhysicsProtocolShareUrl,
  ...
  from "./hierarchy-physics-protocol-packet.mjs?v=20260901-414";
...
const CLAIMS = [
  ...
  ["open", "Atomistic critical-nucleus geometry", "A frozen event schedule can issue a structure-, work-, state-, and schedule-bound request for one independently committor-validated species-labelled critical configuration. A conforming response supplies the atom count, core/interface membership, and local coordinates; seeded proper rotations produce a magnified preview, while growth admission, the GCTS seed, both clocks, heterogeneous-site physics, and ensemble sampling remain unchanged."],
