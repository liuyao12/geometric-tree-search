...
const SYSTEMS = {
  ...
  iqc: {
    ...
    evidence: [
      ...
      ["Frontier states", "336 / 368 sites", "Material-blind promotion of the section-assisted trace: five recurring types plus 32 residual sites."],
...
const TIMELINE = [
  ...
  ["10", "Frontier-state promotion", "Exact wave geometry compresses into five recurring scale-normalized states covering 336 / 368 sites, with every remainder explicit.", "progress"],
...
const CLAIMS = [
  ...
  ["progress", "Frontier-state grammar", "Five recurring scale-normalized state types cover 336 / 368 exact IQC continuation sites; 32 sites remain explicit residuals."],
  ...
  ["open", "Expanding frontier production", "One dimer repeats the golden-ratio scale over three waves, but its unique support shrinks 24 → 12 → 8 and its continuous stabilizer prevents a finite oriented port state."],
