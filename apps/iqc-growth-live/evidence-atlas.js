import { executeIceMolecularAnchorGrowth } from "./ice-molecular-anchor-growth.js?v=20260831-408";
import { buildPeriodicIceIhBoundarySeries } from "./ice-periodic-boundary-audit.mjs?v=20260831-408";
...
import { buildHierarchyPhysicsTransport, HIERARCHY_TRANSPORT_STAGES }
  from "./hierarchy-physics-transport.mjs?v=20260831-408";
import { buildHierarchyPhysicsInvestigation }
  from "./hierarchy-physics-investigation.mjs?v=20260831-408";
...
const PHYSICS_MAP = {
  ...
  kinetics: {
    ...
    boundary: "One finite orientation set is not a complete equilibrium or kinetic habit; one steady velocity field does not transfer across driving state; and one flux map must be recalculated as its frozen interface or transport boundary changes. Morphology supplies none of γ, v, or J; γ does not supply v; geometric visibility is not diffusion. Comparing J/ρsite with v does not justify adding inverse resistances or inferring an effective rate. These priors are not attachment probabilities, complete moving-boundary solutions, or physical clocks. Candidate-resolved HTST remains conditional on the enumerated catalog, so the portal does not claim a universal growth rate or phase diagram.",
    systems: [
