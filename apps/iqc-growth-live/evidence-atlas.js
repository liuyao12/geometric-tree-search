...
const SYSTEMS = {
  ...
  iqc: {
    ...
    evidence: [
      ...
      ["Continuous section", "4 / 4 fresh colored sites", "Nine-nucleus fit; rigid-motion invariant; target opened after the frozen trace."],
...
const TIMELINE = [
  ...
  ["11", "Continuous spatial section", "A species-aware local section trained on nine nuclei ranks a fresh disjoint four-site IQC action first; categorical and ordinal channel identities are retired.", "progress"],
...
const CLAIMS = [
  ...
  ["progress", "Continuous IQC section", "A 49,716-example colored local section transfers to a fresh disjoint nucleus and selects 4 / 4 exact sites; sustained growth is not yet certified."],
