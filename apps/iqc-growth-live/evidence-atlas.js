...
const TIMELINE = [
  ...
  ["17x", "Conditional child value rejected", "Conditioned on those closure parents, a 3,994-candidate / 95-positive child marking supplies all 14 exact parent branches under four-nucleus holdout. On the fifth consumed geometry, however, the two exact six-action continuations rank 132nd and 133rd and neither enters top 16. The model is frozen as a transfer failure, not promoted into downstream growth.", "open"],
