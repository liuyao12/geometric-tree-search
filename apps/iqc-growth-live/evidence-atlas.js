...
const PHYSICS_MAP = {
  ...
  kinetics: {
    ...
    physical: "Temperature, pressure, chemical potentials, free-energy differences, diffusion barriers, nucleation rates, phonons, and time-dependent disorder. Imported relaxation archives can compare geometry-only final, first, or pooled reference mismatch with same-run relative energy or residual-force RMS.",
    ...
    boundary: "The portal predicts structurally admissible continuation, not a growth rate or thermodynamic phase diagram. Final, first, and pooled references are geometry-only sensitivity choices rather than label-selected models. The scatter stays descriptive within one correlated archive: labels never fit or rank growth, and correlation is not independent validation, prediction, causality, a potential, a force field, kinetics, or time. MD/DFT or experimental labels must calibrate kinetic claims separately.",
    systems: [
