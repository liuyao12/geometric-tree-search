...
const sourceHashes=Object.fromEntries(['boron-junction-required-extended.mjs','junction-mandatory-order.mjs','junction-marking-arc-filter.mjs','linear-frontier-decision.mjs','branch-local-exclusions.mjs'].map(n=>[n,hash(readFileSync(new URL(n,import.meta.url)))]));
