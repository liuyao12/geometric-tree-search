...
const sourceHashes=Object.fromEntries(['ice-dynamic-support-search.mjs','portable-cloud-filter.mjs','linear-frontier-decision.mjs','dynamic-half-support.mjs'].map(n=>[n,hash(new URL(n,import.meta.url))]));
