...
export function makeFactorizedCloudSearch(model,pool,{Engine=FactorizedPointSearch,partnerIndex=null}={}){
 ...
 const state=new Engine(model,{compatible,partnerIndex,terminalCheck:e=>factorizedCloudWitnesses(e,pool,model.cloudRadius)});
