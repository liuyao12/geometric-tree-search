...
import { tileSpecs } from "./engine.js?v=20260820-deep-shell-v102";
import {
...
function ensureSolverWorker() {
  ...
  solverWorker = new Worker(new URL("./solver-worker.js?v=20260820-deep-shell-v102", import.meta.url), { type: "module" });
...
function startGrowthBenchmark() {
  ...
  for (const mode of GROWTH_MODES) {
    const worker = new Worker(new URL("./growth-benchmark-worker.js?v=20260820-deep-shell-v102", import.meta.url), { type: "module" });
