...
import { tileSpecs } from "./engine.js?v=20260728-rgb-cells-v22";
...
function ensureSolverWorker() {
  ...
  solverWorker = new Worker(new URL("./solver-worker.js?v=20260728-rgb-cells-v22", import.meta.url), { type: "module" });
...
function startGrowthBenchmark() {
  ...
  for (const mode of GROWTH_MODES) {
    const worker = new Worker(new URL("./growth-benchmark-worker.js?v=20260728-rgb-cells-v22", import.meta.url), { type: "module" });
