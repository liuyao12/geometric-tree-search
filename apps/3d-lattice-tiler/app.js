...
import {
  ...
  tileSpecs
} from "./engine.js?v=20260821-polycube10-v125";
import {
...
function ensureSolverWorker() {
  ...
  solverWorker = new Worker(new URL("./solver-worker.js?v=20260821-polycube10-v125", import.meta.url), { type: "module" });
