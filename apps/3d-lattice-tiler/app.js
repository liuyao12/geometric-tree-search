...
import {
  ...
  tileSpecs
} from "./engine.js?v=20260821-polycube10-v124";
import {
  ...
  if (candidate) {
    ...
    if (periodicLane) {
      ...
      candidateResearchDetail.textContent = candidate.kind === "polycube_census"
        ? candidate.screening.census_stage === "volume10_through10_radius3"
...
function ensureSolverWorker() {
  ...
  solverWorker = new Worker(new URL("./solver-worker.js?v=20260821-polycube10-v124", import.meta.url), { type: "module" });
