...
import { tileSpecs } from "./engine.js?v=20260818-nogood-pivot-v49";
import {
...
function ensureSolverWorker() {
  ...
  solverWorker = new Worker(new URL("./solver-worker.js?v=20260818-nogood-pivot-v49", import.meta.url), { type: "module" });
