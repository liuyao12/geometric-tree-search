...
const records = [
  ...
  },
  {
    ...
    description: "A volume-10 free-isometry representative that survives exact periodic screening through twelve copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive",
      certificate: null,
      census_stage: "volume10_through12_radius3",
      requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 12,
      periodic_hnf_candidates_exhausted: 208971,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy12-2026-08-21.json",
      corona_report: "data/polycube-volume10-gcts-funnel-through9-2026-08-21.json",
      ...
      corona_next_status: "time_limit",
      corona_next_portfolio_runs: 7,
      corona_next_time_limit_ms: 106000,
      corona_next_nodes: 227328,
  ...
  },
  {
    ...
    description: "A volume-10 free-isometry representative that survives exact periodic screening through twelve copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through12_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 12, periodic_hnf_candidates_exhausted: 208971,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy12-2026-08-21.json",
      corona_report: "data/polycube-volume10-gcts-funnel-through9-2026-08-21.json",
      corona_completed_radius: 2, corona_completed_nodes: 1296, corona_completed_target_cells: 93,
      corona_completed_placements: 5232, corona_completed_verified: true,
      corona_next_radius: 3, corona_next_status: "time_limit", corona_next_portfolio_runs: 7,
      corona_next_time_limit_ms: 106000, corona_next_nodes: 292864, corona_next_target_cells: 191,
      corona_next_placements_considered: 9694, corona_next_search_exhausted: false
    },
    shell_screening: { robust_completed_shell: 2, deepest_completed_shell: 2 }
  },
  {
    ...
    description: "A symmetric volume-10 free-isometry representative that survives exact periodic screening through twelve copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through12_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 12, periodic_hnf_candidates_exhausted: 208971,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy12-2026-08-21.json",
      corona_report: "data/polycube-volume10-gcts-funnel-through9-2026-08-21.json",
      corona_completed_radius: 2, corona_completed_nodes: 35, corona_completed_target_cells: 88,
      corona_completed_placements: 2496, corona_completed_verified: true,
      corona_next_radius: 3, corona_next_status: "time_limit", corona_next_portfolio_runs: 7,
      corona_next_time_limit_ms: 106000, corona_next_nodes: 677888, corona_next_target_cells: 182,
      corona_next_placements_considered: 4632, corona_next_search_exhausted: false
    },
    shell_screening: { robust_completed_shell: 2, deepest_completed_shell: 2 }
  },
  {
    ...
    description: "An achiral volume-10 free-isometry representative that survives exact periodic screening through twelve copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through12_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 12, periodic_hnf_candidates_exhausted: 208971,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy12-2026-08-21.json",
      ...
      corona_next_radius: 3, corona_next_status: "time_limit", corona_next_portfolio_runs: 7,
      corona_next_time_limit_ms: 106000, corona_next_nodes: 313344, corona_next_target_cells: 206,
  ...
  },
  {
    ...
    mirror_equivalent_id: null,
    description: "An achiral threefold-symmetric volume-10 free-isometry representative that survives exact periodic screening through twelve copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through12_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 12, periodic_hnf_candidates_exhausted: 208971,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy12-2026-08-21.json",
      ...
      corona_next_radius: 3, corona_next_status: "time_limit", corona_next_portfolio_runs: 7,
      corona_next_time_limit_ms: 106000, corona_next_nodes: 1100800, corona_next_target_cells: 182,
