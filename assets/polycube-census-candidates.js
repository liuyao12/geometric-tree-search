...
const records = [
  ...
  },
  {
    ...
    description: "A volume-10 free-isometry representative that survives exact periodic screening through eleven copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive",
      certificate: null,
      census_stage: "volume10_through11_radius3",
      requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 11,
      periodic_hnf_candidates_exhausted: 146506,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy11-2026-08-21.json",
  ...
  },
  {
    ...
    description: "A volume-10 free-isometry representative that survives exact periodic screening through eleven copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through11_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 11, periodic_hnf_candidates_exhausted: 146506,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy11-2026-08-21.json",
      corona_report: "data/polycube-volume10-gcts-funnel-through9-2026-08-21.json",
  ...
  },
  {
    ...
    description: "A symmetric volume-10 free-isometry representative that survives exact periodic screening through eleven copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through11_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 11, periodic_hnf_candidates_exhausted: 146506,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy11-2026-08-21.json",
  ...
  },
  {
    ...
    description: "An achiral volume-10 free-isometry representative that survives exact periodic screening through eleven copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through11_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 11, periodic_hnf_candidates_exhausted: 146506,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy11-2026-08-21.json",
  ...
  },
  {
    ...
    mirror_equivalent_id: null,
    description: "An achiral threefold-symmetric volume-10 free-isometry representative that survives exact periodic screening through eleven copies and the radius-three GCTS portfolio.",
    screening: {
      status: "inconclusive", certificate: null, census_stage: "volume10_through11_radius3", requires_mirrors: false,
      periodic_hnf_max_motif_tiles: 11, periodic_hnf_candidates_exhausted: 146506,
      periodic_hnf_report: "data/polycube-volume10-periodic-copy11-2026-08-21.json",
