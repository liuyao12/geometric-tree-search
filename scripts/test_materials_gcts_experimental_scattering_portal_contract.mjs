...
assert.match(app, /experimental-scattering-validation\.mjs\?v=20260901-440/);
assert.match(app, /public-powder-profile-library\.mjs\?v=20260901-440/);
assert.match(app, /xray-form-factors\.mjs\?v=20260901-440/);
