...
def test_build_234_is_exposed():
    assert 'buildId: "20260827-234"' in APP
    assert 'app.js?v=20260827-234' in HTML
    assert 'style.css?v=20260827-234' in HTML
