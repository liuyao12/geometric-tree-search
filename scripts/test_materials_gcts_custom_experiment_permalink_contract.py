...
def test_custom_experiment_permalink_contract() -> None:
    ...
    assert 'app.js?v=20260829-326' in HTML
    assert 'style.css?v=20260829-326' in HTML
    assert 'evidence-atlas.js?v=20260829-326' in HTML
    assert 'buildId: "20260829-326"' in APP
