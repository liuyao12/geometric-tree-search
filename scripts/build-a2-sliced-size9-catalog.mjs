...
const candidates = records.map(record => {
  ...
  return {
    ...
    screening: {
      ...
      palindromic_profile_source_pool_size: 1627,
      palindromic_profile_two_copy_periodic_certificates: 1135,
      palindromic_profile_four_copy_additional_periodic_certificates: 304,
      palindromic_profile_survivors_through_four: 188,
      palindromic_profile_reflection_classes_through_four: 114,
      palindromic_profile_six_copy_additional_periodic_classes: 17,
      palindromic_profile_reflection_classes_through_six: 97,
      complete_periodic_survivor_reflection_classes_through_six: 453,
