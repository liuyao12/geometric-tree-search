...
for (const token of ["classical-nucleation-evidence.mjs?v=20260901-446",
  ...
  "growthRankingChanged: activeClassicalCapillarityWeight() > 0", "buildId: \"20260901-446\""]) assert.ok(app.includes(token), token);
