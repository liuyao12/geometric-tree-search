...
for (const token of ["classical-nucleation-evidence.mjs?v=20260901-423",
  ...
  "growthRankingChanged: activeClassicalCapillarityWeight() > 0", "buildId: \"20260901-423\""]) assert.ok(app.includes(token), token);
...
assert.ok(html.includes("app.js?v=20260901-423"));
assert.ok(html.includes("style.css?v=20260901-423"));
assert.ok(html.includes("evidence-atlas.js?v=20260901-423"));
