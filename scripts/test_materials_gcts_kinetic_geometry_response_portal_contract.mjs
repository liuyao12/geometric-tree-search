...
for (const document of [html, alias]) {
  ...
  assert.match(document, /app\.js\?v=20260831-370/);
}
assert.match(app, /kinetic-geometry-response\.mjs\?v=20260831-370/);
...
assert.match(response, /uncertaintyPropagatedIntoResponse: false/);
