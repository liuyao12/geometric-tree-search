...
for (const document of [html, alias]) {
  ...
  assert.match(document, /app\.js\?v=20260831-407/);
  assert.match(document, /evidence-atlas\.js\?v=20260831-407/);
}
assert.match(app, /hierarchy-physics-protocol-conformance\.mjs\?v=20260831-407/);
