...
for (const document of [html, alias]) {
  ...
  assert.match(document, /app\.js\?v=20260831-372/);
}
assert.match(app, /external-action-barrier\.mjs\?v=20260831-372/);
...
assert.match(barrier, /action-path-geometry\.mjs\?v=20260831-372/);
