...
def test_occurrence_uncertainty_ui_contract() -> None:
    ...
    require(APP, 'from "./validation-uncertainty.mjs?v=20260828-312"')
    ...
    require(APP, 'buildId: "20260828-312"')
    require(HTML, 'app.js?v=20260828-312')
    require(HTML, 'style.css?v=20260828-312')
