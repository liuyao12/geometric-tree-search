...
def test_cdyb_site_section_portal_contract() -> None:
    ...
    assert 'buildId: "20260901-433"' in APP
    assert 'app.js?v=20260901-433' in HTML
    assert 'style.css?v=20260901-433' in HTML
    assert 'evidence-atlas.js?v=20260901-433' in HTML
