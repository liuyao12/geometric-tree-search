...
def test_cdyb_site_section_portal_contract() -> None:
    ...
    assert 'buildId: "20260830-342"' in APP
    assert 'app.js?v=20260830-342' in HTML
    assert 'style.css?v=20260830-342' in HTML
    assert 'evidence-atlas.js?v=20260830-342' in HTML
