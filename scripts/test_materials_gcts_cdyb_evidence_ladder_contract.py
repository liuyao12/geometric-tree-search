...
def test_cdyb_evidence_ladder_contract():
    ...
    assert 'evidence-atlas.js?v=20260829-331' in HTML
    assert 'app.js?v=20260829-331' in HTML
    assert 'style.css?v=20260829-331' in HTML
    assert 'buildId: "20260829-331"' in APP
