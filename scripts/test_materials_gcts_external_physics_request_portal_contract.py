...
def test_build_338_is_documented_and_cache_busted():
    for document in (HTML, ALIAS_HTML):
        assert 'app.js?v=20260830-338' in document
        assert 'style.css?v=20260830-338' in document
        assert 'evidence-atlas.js?v=20260830-338' in document
        assert 'downloaded locally with exact Å coordinates' in document
