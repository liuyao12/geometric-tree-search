...
def test_workflow_routing_contract():
    ...
    assert 'buildId: "20260829-333"' in APP
    assert 'app.js?v=20260829-333' in HTML
    assert 'style.css?v=20260829-333' in HTML
    assert 'evidence-atlas.js?v=20260829-333' in HTML
