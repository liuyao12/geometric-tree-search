...
for (const document of [html, alias]) {
  ...
  assert.match(document, /app\.js\?v=20260831-389/);
}
assert.match(app, /geometric-state-descriptor\.mjs\?v=20260831-389/);
assert.match(app, /finite-network-global-order\.mjs\?v=20260831-389/);
