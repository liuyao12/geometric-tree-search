...
assert.equal(p10052588Survivor.census_candidate.screening.corona_bounded_exhaustion_maximum_placements, 44);
assert.equal(p10052588Survivor.census_candidate.screening.corona_bounded_exhaustion_independent_unsat_runs, 1);
assert.equal(p10052588Survivor.census_candidate.screening.corona_widened_exhaustion_unsat_seed, 229);
assert.equal(p10052588Survivor.census_candidate.screening.corona_widened_exhaustion_unknown_runs, 2);
