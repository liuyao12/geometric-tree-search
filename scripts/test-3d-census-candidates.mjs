...
assert.equal(archivedPolycubeZ3Cegar.radius_4_to_5.combined_exact_dead_outer_states, 281);
assert.equal(archivedPolycubeZ3Cegar.radius_4_to_5.combined_symmetry_closed_clauses, 798);
...
assert.equal(volumeNineSurvivor.census_candidate.screening.corona_cegar_radius4_states_checked, 281);
assert.equal(volumeNineSurvivor.census_candidate.screening.corona_cegar_symmetry_closed_clauses, 798);
