...
def test_build_339_is_documented_and_cache_busted():
    for document in (HTML, ALIAS_HTML):
        assert 'app.js?v=20260901-412' in document
        assert 'style.css?v=20260901-412' in document
        assert 'evidence-atlas.js?v=20260901-412' in document
