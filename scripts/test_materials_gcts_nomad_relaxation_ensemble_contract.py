...
def test_nomad_query_selects_full_runs_only_for_geometry_optimizations():
    ...
    assert 'calculation: { energy: "*", forces: "*", stress: "*", charges: "*", system_ref: "*", method_ref: "*" }' in DATABASE
...
def test_current_build_is_cache_busted():
    assert 'buildId: "20260827-277"' in APP
    assert 'structure-io.js?v=20260827-8' in APP
