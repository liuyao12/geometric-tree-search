...
def test_build_342_is_cache_busted():
    for document in (HTML, ALIAS_HTML):
        assert 'app.js?v=20260831-367' in document
        assert 'style.css?v=20260831-367' in document
        assert 'evidence-atlas.js?v=20260831-367' in document
    assert 'buildId: "20260831-367"' in APP
