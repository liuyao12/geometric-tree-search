...
radius-two patch and exhausts 146,506 exact HNF quotient bases through eleven
...
`data/polycube-volume10-periodic-copy10-2026-08-21.json`; the absolute-resume
eleven-copy layer is `data/polycube-volume10-periodic-copy11-2026-08-21.json`.
None of these bounded results proves tiling or aperiodicity.
...
5. For durable survivors, search for recurring supertiles and verify a forced
   ...
   state paths.
6. Extend the five volume-ten free classes beyond eleven-copy HNF quotients and
